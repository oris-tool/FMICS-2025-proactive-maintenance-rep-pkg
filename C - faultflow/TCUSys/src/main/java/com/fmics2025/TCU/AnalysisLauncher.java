...
public class AnalysisLauncher {
    ...
    public static void main(String[] args) throws IOException {
        //Build System
        SystemType s = TCUSystemBuilder.getInstance().getSystem();

        //Analysis parameters
        double timeLimit = 60000;
        double timeStep = 4.0;
        double error = 0.0;
        //--> ANALYSIS WITH SIRIO
        sirioAnalysis("AZFailure", s, timeLimit, timeStep, error);
        
        //-->ANALYSIS WITH PYRAMIS
        ErrorMode errorMode = TCUSystemBuilder.getErrorMode("AZOR1");
    ...
    public static void sirioAnalysis(String failureName, SystemType s, double timeLimit, double timeStep, double error) throws IOException {
        ...
        petriNetReducer.reduce(failureName, TCUSystemBuilder.getPropagationPorts(), TCUSystemBuilder.getErrorModes());
